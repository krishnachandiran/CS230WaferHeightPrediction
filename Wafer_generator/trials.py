...
cv2.circle(img3,(130,353), 600, (128,128,128), -1)
cv2.circle(img2,(30,353), 600, (128,128,128), -1)
cv2.circle(img1,(430,353), 600, (128,128,128), -1)
...
cv2.circle(img3,(130+20,353+23), 3, (130,130,130), -1)
cv2.circle(img2,(130-10,353-53), 3, (130,130,130), -1)
cv2.circle(img1,(130,353+70), 3, (130,130,130), -1)
#cv2.circle(img2,(130,353+70), 3, (135,135,135), -1)

cv2.circle(img3,(13,353), 3, (50,50,50), -1)
cv2.circle(img2,(134,33), 3, (50,50,50), -1)
cv2.circle(img1,(300,370), 3, (50,50,50), -1)

path = r'C:\Work\CY21 University Engagement\Wafer_Swath_Generator\Checking'
